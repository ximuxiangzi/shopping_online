import Vue from 'vue'
import Loading from './loadingold.vue'
// import Loading from './lessLoading.vue'
// import Loading from './loadingThree'
// import Loading from './loadingFour'
/**
...
const toggleLoading = (el, binding) => {
    ...
    if (binding.value) {
        Vue.nextTick(() => {
            ...
            el.instance.zoom = binding.value
            // 插入到目标元素
